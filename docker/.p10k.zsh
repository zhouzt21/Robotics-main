# Generated by Powerlevel10k configuration wizard on 2023-11-22 at 22:37 UTC.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 27973.
# Wizard options: compatible, lean_8colors, unicode, 12h time, 2 lines, dotted,
# no frame, white-ornaments, compact, fluent, transient_prompt, instant_prompt=verbose.
